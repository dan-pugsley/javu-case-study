...
<p align="center">
  <img src="assets/screenshots/home.png"     width="30%" alt="Home dashboard — launch a quiz, Word of the Day, and per-language progress" />
  &nbsp;
...
<p align="center">
  <img src="assets/screenshots/languages.png" width="30%" alt="Language picker — English, Spanish, French, Italian, Portuguese active; German, Japanese, Korean, Chinese marked Coming soon" />
</p>
<p align="center"><sub>The live language picker — five active today, more modelled and on the way.</sub></p>
...
sequenceDiagram
    ...
    alt Cache hit
        ...
        SVC->>DB: Persist — cached for every future learner
...
- **Haptics wired to meaning.** Light impacts on toggles, a success notification pattern on a correct answer — touch feedback that's tied to events, not sprinkled at random.
